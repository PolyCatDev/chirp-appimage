...
RUN curl -L -O https://archive.chirpmyradio.com/chirp_next/next-20251205/chirp-20251205-py3-none-any.whl && \
    /build/usr/bin/python3.10 -m pip install --prefix=/build/usr chirp-20251205-py3-none-any.whl && \
